...
public sealed class LikesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetMyLikedPosts(CancellationToken cancellationToken)
    {
        ...
        var posts = await _likeService.GetLikedPostsAsync(userId, cancellationToken);
        ...
        return Ok(ApiResponse.Ok("Liked posts loaded successfully.", result));
    }
}
