...
public sealed class LikeService : ILikeService
{
    ...
    public Task<IList<Post>> GetLikedPostsAsync(string userId, CancellationToken cancellationToken = default)
    {
        return _likeRepository.GetLikedPostsAsync(userId, cancellationToken);
    }
}
